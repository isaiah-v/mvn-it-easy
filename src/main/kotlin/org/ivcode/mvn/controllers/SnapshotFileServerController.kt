...
public const val REPO_SNAPSHOT: String = "snapshot"

@Controller
@RequestMapping(path = ["/${REPO_SNAPSHOT}"])
public class SnapshotFileServerController (
    @Qualifier("snapshot.file-service") fileServerService: FileServerService,
